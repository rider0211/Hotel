    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.leads.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('homephone') ? 'is-invalid' : '' }}" type="text" name="homephone" id="homephone" value="{{ old('homephone', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('goog_address') ? 'is-invalid' : '' }}" type="text" name="goog_address" id="goog_address" value="{{ old('goog_address', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('lead_lon') ? 'is-invalid' : '' }}" type="text" name="lead_lon" id="lead_lon" value="{{ old('lead_lon', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('lead_lat') ? 'is-invalid' : '' }}" type="text" name="lead_lat" id="lead_lat" value="{{ old('lead_lat', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('lead_street') ? 'is-invalid' : '' }}" type="text" name="lead_street" id="lead_street" value="{{ old('lead_street', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('lead_lot') ? 'is-invalid' : '' }}" type="text" name="lead_lot" id="lead_lot" value="{{ old('lead_lot', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('lead_city') ? 'is-invalid' : '' }}" type="text" name="lead_city" id="lead_city" value="{{ old('lead_city', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('lead_state') ? 'is-invalid' : '' }}" type="text" name="lead_state" id="lead_state" value="{{ old('lead_state', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('lead_zip') ? 'is-invalid' : '' }}" type="text" name="lead_zip" id="lead_zip" value="{{ old('lead_zip', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('lead_county') ? 'is-invalid' : '' }}" type="text" name="lead_county" id="lead_county" value="{{ old('lead_county', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('dateassigned') ? 'is-invalid' : '' }}" type="text" name="dateassigned" id="dateassigned" value="{{ old('dateassigned', '') }}">
