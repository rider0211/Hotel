...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.changeOrder.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.change-orders.update", [$changeOrder->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                <label for="est_title">{{ trans('cruds.changeOrder.fields.est_title') }}</label>
                <input class="form-control {{ $errors->has('est_title') ? 'is-invalid' : '' }}" type="text" name="est_title" id="est_title" value="{{ old('est_title', $changeOrder->est_title) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('est_stat') ? 'is-invalid' : '' }}" type="text" name="est_stat" id="est_stat" value="{{ old('est_stat', $changeOrder->est_stat) }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('est_state') ? 'is-invalid' : '' }}" name="est_state" id="est_state" required>
                    ...
                    @foreach(App\Models\ChangeOrder::EST_STATE_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('est_state', $changeOrder->est_state) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('est_county') ? 'is-invalid' : '' }}" name="est_county" id="est_county" required>
                    ...
                    @foreach(App\Models\ChangeOrder::EST_COUNTY_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('est_county', $changeOrder->est_county) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('est_total_before_tax') ? 'is-invalid' : '' }}" type="number" name="est_total_before_tax" id="est_total_before_tax" value="{{ old('est_total_before_tax', $changeOrder->est_total_before_tax) }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('est_state_tax') ? 'is-invalid' : '' }}" type="text" name="est_state_tax" id="est_state_tax" value="{{ old('est_state_tax', $changeOrder->est_state_tax) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('est_county_tax') ? 'is-invalid' : '' }}" type="text" name="est_county_tax" id="est_county_tax" value="{{ old('est_county_tax', $changeOrder->est_county_tax) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('est_total_after_tax') ? 'is-invalid' : '' }}" type="text" name="est_total_after_tax" id="est_total_after_tax" value="{{ old('est_total_after_tax', $changeOrder->est_total_after_tax) }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('est_note') ? 'is-invalid' : '' }}" name="est_note" id="est_note">{!! old('est_note', $changeOrder->est_note) !!}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('dep_calc_1') ? 'is-invalid' : '' }}" type="text" name="dep_calc_1" id="dep_calc_1" value="{{ old('dep_calc_1', $changeOrder->dep_calc_1) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('dep_calc_2') ? 'is-invalid' : '' }}" type="text" name="dep_calc_2" id="dep_calc_2" value="{{ old('dep_calc_2', $changeOrder->dep_calc_2) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('dep_calc_3') ? 'is-invalid' : '' }}" type="text" name="dep_calc_3" id="dep_calc_3" value="{{ old('dep_calc_3', $changeOrder->dep_calc_3) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('est_desposit_1') ? 'is-invalid' : '' }}" type="number" name="est_desposit_1" id="est_desposit_1" value="{{ old('est_desposit_1', $changeOrder->est_desposit_1) }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('est_desposit_2') ? 'is-invalid' : '' }}" type="number" name="est_desposit_2" id="est_desposit_2" value="{{ old('est_desposit_2', $changeOrder->est_desposit_2) }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('est_deposit_3') ? 'is-invalid' : '' }}" type="number" name="est_deposit_3" id="est_deposit_3" value="{{ old('est_deposit_3', $changeOrder->est_deposit_3) }}" step="0.01">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('est_view_price') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="est_view_price" id="est_view_price" value="1" {{ $changeOrder->est_view_price || old('est_view_price', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('est_view_qty') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="est_view_qty" id="est_view_qty" value="1" {{ $changeOrder->est_view_qty || old('est_view_qty', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('est_view_detail') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="est_view_detail" id="est_view_detail" value="1" {{ $changeOrder->est_view_detail || old('est_view_detail', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('est_access') ? 'is-invalid' : '' }}" type="text" name="est_access" id="est_access" value="{{ old('est_access', $changeOrder->est_access) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('est_cust_email_signed') ? 'is-invalid' : '' }}" type="text" name="est_cust_email_signed" id="est_cust_email_signed" value="{{ old('est_cust_email_signed', $changeOrder->est_cust_email_signed) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('est_cust_first_signed') ? 'is-invalid' : '' }}" type="text" name="est_cust_first_signed" id="est_cust_first_signed" value="{{ old('est_cust_first_signed', $changeOrder->est_cust_first_signed) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('est_cust_last_signed') ? 'is-invalid' : '' }}" type="text" name="est_cust_last_signed" id="est_cust_last_signed" value="{{ old('est_cust_last_signed', $changeOrder->est_cust_last_signed) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('est_sign') ? 'is-invalid' : '' }}" type="text" name="est_sign" id="est_sign" value="{{ old('est_sign', $changeOrder->est_sign) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('est_sign_int') ? 'is-invalid' : '' }}" type="text" name="est_sign_int" id="est_sign_int" value="{{ old('est_sign_int', $changeOrder->est_sign_int) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('est_approve_date') ? 'is-invalid' : '' }}" type="text" name="est_approve_date" id="est_approve_date" value="{{ old('est_approve_date', $changeOrder->est_approve_date) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('est_user_ip') ? 'is-invalid' : '' }}" type="text" name="est_user_ip" id="est_user_ip" value="{{ old('est_user_ip', $changeOrder->est_user_ip) }}">
