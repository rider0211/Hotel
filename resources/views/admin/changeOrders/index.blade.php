...
@can('change_order_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="{{ route('admin.change-orders.create') }}">
                        ...
                        <tr data-entry-id="{{ $changeOrder->id }}">
                            ...
                            <td>
                                @can('change_order_show')
                                    <a class="btn btn-xs btn-primary" href="{{ route('admin.change-orders.show', $changeOrder->id) }}">
                                        {{ trans('global.view') }}
                                    </a>
                                @endcan

                                @can('change_order_edit')
                                    <a class="btn btn-xs btn-info" href="{{ route('admin.change-orders.edit', $changeOrder->id) }}">
                                        {{ trans('global.edit') }}
                                    </a>
                                @endcan

                                @can('change_order_delete')
                                    <form action="{{ route('admin.change-orders.destroy', $changeOrder->id) }}" method="POST" onsubmit="return confirm('{{ trans('global.areYouSure') }}');" style="display: inline-block;">
...
@can('change_order_delete')
  ...
  let deleteButton = {
    ...
    url: "{{ route('admin.change-orders.massDestroy') }}",
