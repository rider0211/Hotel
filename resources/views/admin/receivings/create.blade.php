...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.receivings.store") }}" enctype="multipart/form-data">
            @csrf
            <div class="form-group">
                <label class="required" for="rcv_vendor">{{ trans('cruds.receiving.fields.rcv_vendor') }}</label>
                <input class="form-control {{ $errors->has('rcv_vendor') ? 'is-invalid' : '' }}" type="text" name="rcv_vendor" id="rcv_vendor" value="{{ old('rcv_vendor', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('rcv_expected') ? 'is-invalid' : '' }}" type="text" name="rcv_expected" id="rcv_expected" value="{{ old('rcv_expected') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('rcv_received') ? 'is-invalid' : '' }}" type="text" name="rcv_received" id="rcv_received" value="{{ old('rcv_received') }}">
