    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.appointments.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('appt_start_date') ? 'is-invalid' : '' }}" type="text" name="appt_start_date" id="appt_start_date" value="{{ old('appt_start_date') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('appt_end_date') ? 'is-invalid' : '' }}" type="text" name="appt_end_date" id="appt_end_date" value="{{ old('appt_end_date') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('appt_notes') ? 'is-invalid' : '' }}" type="text" name="appt_notes" id="appt_notes" value="{{ old('appt_notes', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ms_id_appt_result') ? 'is-invalid' : '' }}" type="text" name="ms_id_appt_result" id="ms_id_appt_result" value="{{ old('ms_id_appt_result', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ms_id_appt_reason') ? 'is-invalid' : '' }}" type="text" name="ms_id_appt_reason" id="ms_id_appt_reason" value="{{ old('ms_id_appt_reason', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('appt_result_code_description') ? 'is-invalid' : '' }}" type="text" name="appt_result_code_description" id="appt_result_code_description" value="{{ old('appt_result_code_description', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('id_appt_type') ? 'is-invalid' : '' }}" type="text" name="id_appt_type" id="id_appt_type" value="{{ old('id_appt_type', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ms_id_appt_type') ? 'is-invalid' : '' }}" type="text" name="ms_id_appt_type" id="ms_id_appt_type" value="{{ old('ms_id_appt_type', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ms_id_appt') ? 'is-invalid' : '' }}" type="text" name="ms_id_appt" id="ms_id_appt" value="{{ old('ms_id_appt', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ms_id_lead') ? 'is-invalid' : '' }}" type="text" name="ms_id_lead" id="ms_id_lead" value="{{ old('ms_id_lead', '') }}">
                @if($errors->has('ms_id_lead'))
                    <span class="text-danger">{{ $errors->first('ms_id_lead') }}</span>
                @endif
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('appt_sales_1_emp') ? 'is-invalid' : '' }}" type="text" name="appt_sales_1_emp" id="appt_sales_1_emp" value="{{ old('appt_sales_1_emp', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('appt_subject') ? 'is-invalid' : '' }}" type="text" name="appt_subject" id="appt_subject" value="{{ old('appt_subject', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ms_appt_set_by') ? 'is-invalid' : '' }}" type="text" name="ms_appt_set_by" id="ms_appt_set_by" value="{{ old('ms_appt_set_by', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('confirmation_activity') ? 'is-invalid' : '' }}" type="text" name="confirmation_activity" id="confirmation_activity" value="{{ old('confirmation_activity', '') }}">
