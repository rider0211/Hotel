    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.payments.update", [$payment->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('pay_amount') ? 'is-invalid' : '' }}" type="text" name="pay_amount" id="pay_amount" value="{{ old('pay_amount', $payment->pay_amount) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('job') ? 'is-invalid' : '' }}" type="text" name="job" id="job" value="{{ old('job', $payment->job) }}">
                @if($errors->has('job'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('company') ? 'is-invalid' : '' }}" type="text" name="company" id="company" value="{{ old('company', $payment->company) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('payment_type') ? 'is-invalid' : '' }}" type="text" name="payment_type" id="payment_type" value="{{ old('payment_type', $payment->payment_type) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('contract') ? 'is-invalid' : '' }}" type="text" name="contract" id="contract" value="{{ old('contract', $payment->contract) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('payment_amount') ? 'is-invalid' : '' }}" type="text" name="payment_amount" id="payment_amount" value="{{ old('payment_amount', $payment->payment_amount) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('payment_description') ? 'is-invalid' : '' }}" type="text" name="payment_description" id="payment_description" value="{{ old('payment_description', $payment->payment_description) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('payment_date_time') ? 'is-invalid' : '' }}" type="text" name="payment_date_time" id="payment_date_time" value="{{ old('payment_date_time', $payment->payment_date_time) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('payment_cc_no') ? 'is-invalid' : '' }}" type="text" name="payment_cc_no" id="payment_cc_no" value="{{ old('payment_cc_no', $payment->payment_cc_no) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('applies_to_contract') ? 'is-invalid' : '' }}" type="text" name="applies_to_contract" id="applies_to_contract" value="{{ old('applies_to_contract', $payment->applies_to_contract) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('cashfinance') ? 'is-invalid' : '' }}" type="text" name="cashfinance" id="cashfinance" value="{{ old('cashfinance', $payment->cashfinance) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('is_active') ? 'is-invalid' : '' }}" type="text" name="is_active" id="is_active" value="{{ old('is_active', $payment->is_active) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('last_updateby') ? 'is-invalid' : '' }}" type="text" name="last_updateby" id="last_updateby" value="{{ old('last_updateby', $payment->last_updateby) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('last_update') ? 'is-invalid' : '' }}" type="text" name="last_update" id="last_update" value="{{ old('last_update', $payment->last_update) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('paysimple_payment') ? 'is-invalid' : '' }}" type="text" name="paysimple_payment" id="paysimple_payment" value="{{ old('paysimple_payment', $payment->paysimple_payment) }}">
