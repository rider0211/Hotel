...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.activityReference.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.activity-references.update", [$activityReference->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                <label for="act_notes">{{ trans('cruds.activityReference.fields.act_notes') }}</label>
                <textarea class="form-control ckeditor {{ $errors->has('act_notes') ? 'is-invalid' : '' }}" name="act_notes" id="act_notes">{!! old('act_notes', $activityReference->act_notes) !!}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('act_due_by') ? 'is-invalid' : '' }}" type="text" name="act_due_by" id="act_due_by" value="{{ old('act_due_by', $activityReference->act_due_by) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('refer_name') ? 'is-invalid' : '' }}" type="text" name="refer_name" id="refer_name" value="{{ old('refer_name', $activityReference->refer_name) }}" required>
