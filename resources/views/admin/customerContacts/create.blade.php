    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.customer-contacts.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('id_cust_status') ? 'is-invalid' : '' }}" type="text" name="id_cust_status" id="id_cust_status" value="{{ old('id_cust_status', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('cust_fullname') ? 'is-invalid' : '' }}" type="text" name="cust_fullname" id="cust_fullname" value="{{ old('cust_fullname', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('cust_title') ? 'is-invalid' : '' }}" type="text" name="cust_title" id="cust_title" value="{{ old('cust_title', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('cust_email_2') ? 'is-invalid' : '' }}" type="email" name="cust_email_2" id="cust_email_2" value="{{ old('cust_email_2') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('cust_phone') ? 'is-invalid' : '' }}" type="text" name="cust_phone" id="cust_phone" value="{{ old('cust_phone', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('cust_phone_2') ? 'is-invalid' : '' }}" type="text" name="cust_phone_2" id="cust_phone_2" value="{{ old('cust_phone_2', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('cust_fax') ? 'is-invalid' : '' }}" type="text" name="cust_fax" id="cust_fax" value="{{ old('cust_fax', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('cust_address') ? 'is-invalid' : '' }}" type="text" name="cust_address" id="cust_address" value="{{ old('cust_address', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('cust_route') ? 'is-invalid' : '' }}" type="text" name="cust_route" id="cust_route" value="{{ old('cust_route', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('cust_city') ? 'is-invalid' : '' }}" type="text" name="cust_city" id="cust_city" value="{{ old('cust_city', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('cust_state') ? 'is-invalid' : '' }}" type="text" name="cust_state" id="cust_state" value="{{ old('cust_state', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('cust_zip') ? 'is-invalid' : '' }}" type="text" name="cust_zip" id="cust_zip" value="{{ old('cust_zip', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('cust_county') ? 'is-invalid' : '' }}" type="text" name="cust_county" id="cust_county" value="{{ old('cust_county', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('cust_lat') ? 'is-invalid' : '' }}" type="text" name="cust_lat" id="cust_lat" value="{{ old('cust_lat', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('cust_lon') ? 'is-invalid' : '' }}" type="text" name="cust_lon" id="cust_lon" value="{{ old('cust_lon', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('cust_note') ? 'is-invalid' : '' }}" type="text" name="cust_note" id="cust_note" value="{{ old('cust_note', '') }}">
