    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.activities.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('act_start') ? 'is-invalid' : '' }}" type="text" name="act_start" id="act_start" value="{{ old('act_start') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('act_end') ? 'is-invalid' : '' }}" type="text" name="act_end" id="act_end" value="{{ old('act_end') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('activity_name') ? 'is-invalid' : '' }}" type="text" name="activity_name" id="activity_name" value="{{ old('activity_name', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('activity_type') ? 'is-invalid' : '' }}" type="text" name="activity_type" id="activity_type" value="{{ old('activity_type', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('activity_reference') ? 'is-invalid' : '' }}" type="text" name="activity_reference" id="activity_reference" value="{{ old('activity_reference', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('activity_result') ? 'is-invalid' : '' }}" type="text" name="activity_result" id="activity_result" value="{{ old('activity_result', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('activity_completed_date') ? 'is-invalid' : '' }}" type="text" name="activity_completed_date" id="activity_completed_date" value="{{ old('activity_completed_date', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('activity_due_date') ? 'is-invalid' : '' }}" type="text" name="activity_due_date" id="activity_due_date" value="{{ old('activity_due_date', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('activity_reminder_minutes') ? 'is-invalid' : '' }}" type="text" name="activity_reminder_minutes" id="activity_reminder_minutes" value="{{ old('activity_reminder_minutes', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('activity_notes') ? 'is-invalid' : '' }}" type="text" name="activity_notes" id="activity_notes" value="{{ old('activity_notes', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('appt') ? 'is-invalid' : '' }}" type="text" name="appt" id="appt" value="{{ old('appt', '') }}">
                @if($errors->has('appt'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('activity_assign_emp') ? 'is-invalid' : '' }}" type="text" name="activity_assign_emp" id="activity_assign_emp" value="{{ old('activity_assign_emp', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('activity_sched_emp') ? 'is-invalid' : '' }}" type="text" name="activity_sched_emp" id="activity_sched_emp" value="{{ old('activity_sched_emp', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('activity_reminder_is_dismissed') ? 'is-invalid' : '' }}" type="text" name="activity_reminder_is_dismissed" id="activity_reminder_is_dismissed" value="{{ old('activity_reminder_is_dismissed', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('id_led') ? 'is-invalid' : '' }}" type="text" name="id_led" id="id_led" value="{{ old('id_led', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('activityresultid') ? 'is-invalid' : '' }}" type="text" name="activityresultid" id="activityresultid" value="{{ old('activityresultid', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('activityreferenceid') ? 'is-invalid' : '' }}" type="text" name="activityreferenceid" id="activityreferenceid" value="{{ old('activityreferenceid', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('t_scheduler_event') ? 'is-invalid' : '' }}" type="text" name="t_scheduler_event" id="t_scheduler_event" value="{{ old('t_scheduler_event', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('activity_process_step') ? 'is-invalid' : '' }}" type="text" name="activity_process_step" id="activity_process_step" value="{{ old('activity_process_step', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('id_job') ? 'is-invalid' : '' }}" type="text" name="id_job" id="id_job" value="{{ old('id_job', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('process_type_steps') ? 'is-invalid' : '' }}" type="text" name="process_type_steps" id="process_type_steps" value="{{ old('process_type_steps', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('service_order') ? 'is-invalid' : '' }}" type="text" name="service_order" id="service_order" value="{{ old('service_order', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('contact_marketing_queue') ? 'is-invalid' : '' }}" type="text" name="contact_marketing_queue" id="contact_marketing_queue" value="{{ old('contact_marketing_queue', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('column_27') ? 'is-invalid' : '' }}" type="text" name="column_27" id="column_27" value="{{ old('column_27', '') }}">
