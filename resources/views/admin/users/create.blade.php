    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.users.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('user_company') ? 'is-invalid' : '' }}" type="number" name="user_company" id="user_company" value="{{ old('user_company', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('user_status') ? 'is-invalid' : '' }}" type="number" name="user_status" id="user_status" value="{{ old('user_status', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('user_role') ? 'is-invalid' : '' }}" type="number" name="user_role" id="user_role" value="{{ old('user_role', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('user_dept') ? 'is-invalid' : '' }}" type="number" name="user_dept" id="user_dept" value="{{ old('user_dept', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('user_title') ? 'is-invalid' : '' }}" type="number" name="user_title" id="user_title" value="{{ old('user_title', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('user_color') ? 'is-invalid' : '' }}" type="text" name="user_color" id="user_color" value="{{ old('user_color', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('goog_pw') ? 'is-invalid' : '' }}" type="text" name="goog_pw" id="goog_pw" value="{{ old('goog_pw', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ticketit_admin') ? 'is-invalid' : '' }}" type="number" name="ticketit_admin" id="ticketit_admin" value="{{ old('ticketit_admin', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ticketit_agent') ? 'is-invalid' : '' }}" type="text" name="ticketit_agent" id="ticketit_agent" value="{{ old('ticketit_agent', '') }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('last_updated_by') ? 'is-invalid' : '' }}" name="last_updated_by_id" id="last_updated_by_id">
                    @foreach($last_updated_bies as $id => $entry)
                        <option value="{{ $id }}" {{ old('last_updated_by_id') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('ms_is_active') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="ms_is_active" id="ms_is_active" value="1" {{ old('ms_is_active', 0) == 1 ? 'checked' : '' }}>
