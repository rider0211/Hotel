    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.contracts.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ctr_name') ? 'is-invalid' : '' }}" type="text" name="ctr_name" id="ctr_name" value="{{ old('ctr_name', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('contract_date') ? 'is-invalid' : '' }}" type="text" name="contract_date" id="contract_date" value="{{ old('contract_date', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('contract_status') ? 'is-invalid' : '' }}" type="text" name="contract_status" id="contract_status" value="{{ old('contract_status', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('contract_date_complete') ? 'is-invalid' : '' }}" type="text" name="contract_date_complete" id="contract_date_complete" value="{{ old('contract_date_complete', '') }}">
