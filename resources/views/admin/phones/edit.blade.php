    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.phones.update", [$phone->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ms_phone_type_name') ? 'is-invalid' : '' }}" type="text" name="ms_phone_type_name" id="ms_phone_type_name" value="{{ old('ms_phone_type_name', $phone->ms_phone_type_name) }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('primary_phone_type') ? 'is-invalid' : '' }}" name="primary_phone_type" id="primary_phone_type" required>
                    ...
                    @foreach(App\Models\Phone::PRIMARY_PHONE_TYPE_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('primary_phone_type', $phone->primary_phone_type) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('primary_phone') ? 'is-invalid' : '' }}" type="text" name="primary_phone" id="primary_phone" value="{{ old('primary_phone', $phone->primary_phone) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('phone_contact') ? 'is-invalid' : '' }}" type="text" name="phone_contact" id="phone_contact" value="{{ old('phone_contact', $phone->phone_contact) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('primary_ext') ? 'is-invalid' : '' }}" type="text" name="primary_ext" id="primary_ext" value="{{ old('primary_ext', $phone->primary_ext) }}">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('primary_dnc') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="primary_dnc" id="primary_dnc" value="1" {{ $phone->primary_dnc || old('primary_dnc', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('primary_dnt') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="primary_dnt" id="primary_dnt" value="1" {{ $phone->primary_dnt || old('primary_dnt', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('phone') ? 'is-invalid' : '' }}" type="text" name="phone" id="phone" value="{{ old('phone', $phone->phone) }}">
                @if($errors->has('phone'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ms_access_company') ? 'is-invalid' : '' }}" type="text" name="ms_access_company" id="ms_access_company" value="{{ old('ms_access_company', $phone->ms_access_company) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ms_phone_type') ? 'is-invalid' : '' }}" type="text" name="ms_phone_type" id="ms_phone_type" value="{{ old('ms_phone_type', $phone->ms_phone_type) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ms_phone_cty_code') ? 'is-invalid' : '' }}" type="text" name="ms_phone_cty_code" id="ms_phone_cty_code" value="{{ old('ms_phone_cty_code', $phone->ms_phone_cty_code) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ms_phone_area_code') ? 'is-invalid' : '' }}" type="text" name="ms_phone_area_code" id="ms_phone_area_code" value="{{ old('ms_phone_area_code', $phone->ms_phone_area_code) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ms_phone_number') ? 'is-invalid' : '' }}" type="text" name="ms_phone_number" id="ms_phone_number" value="{{ old('ms_phone_number', $phone->ms_phone_number) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ms_primary_phone_type') ? 'is-invalid' : '' }}" type="text" name="ms_primary_phone_type" id="ms_primary_phone_type" value="{{ old('ms_primary_phone_type', $phone->ms_primary_phone_type) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ms_phone_dnc') ? 'is-invalid' : '' }}" type="text" name="ms_phone_dnc" id="ms_phone_dnc" value="{{ old('ms_phone_dnc', $phone->ms_phone_dnc) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ms_phone_fed_do_not_call') ? 'is-invalid' : '' }}" type="text" name="ms_phone_fed_do_not_call" id="ms_phone_fed_do_not_call" value="{{ old('ms_phone_fed_do_not_call', $phone->ms_phone_fed_do_not_call) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ms_phone_state_do_not_call') ? 'is-invalid' : '' }}" type="text" name="ms_phone_state_do_not_call" id="ms_phone_state_do_not_call" value="{{ old('ms_phone_state_do_not_call', $phone->ms_phone_state_do_not_call) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ms_written_permission_dnc') ? 'is-invalid' : '' }}" type="text" name="ms_written_permission_dnc" id="ms_written_permission_dnc" value="{{ old('ms_written_permission_dnc', $phone->ms_written_permission_dnc) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('ms_phone_dnc_exempt_date') ? 'is-invalid' : '' }}" type="text" name="ms_phone_dnc_exempt_date" id="ms_phone_dnc_exempt_date" value="{{ old('ms_phone_dnc_exempt_date', $phone->ms_phone_dnc_exempt_date) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ms_phone_dnc_exempt') ? 'is-invalid' : '' }}" type="text" name="ms_phone_dnc_exempt" id="ms_phone_dnc_exempt" value="{{ old('ms_phone_dnc_exempt', $phone->ms_phone_dnc_exempt) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ms_phone_house_do_not_call') ? 'is-invalid' : '' }}" type="text" name="ms_phone_house_do_not_call" id="ms_phone_house_do_not_call" value="{{ old('ms_phone_house_do_not_call', $phone->ms_phone_house_do_not_call) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ms_phone_description') ? 'is-invalid' : '' }}" type="text" name="ms_phone_description" id="ms_phone_description" value="{{ old('ms_phone_description', $phone->ms_phone_description) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ms_phone_ext') ? 'is-invalid' : '' }}" type="text" name="ms_phone_ext" id="ms_phone_ext" value="{{ old('ms_phone_ext', $phone->ms_phone_ext) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ms_phone_do_not_fax') ? 'is-invalid' : '' }}" type="text" name="ms_phone_do_not_fax" id="ms_phone_do_not_fax" value="{{ old('ms_phone_do_not_fax', $phone->ms_phone_do_not_fax) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ms_is_active') ? 'is-invalid' : '' }}" type="text" name="ms_is_active" id="ms_is_active" value="{{ old('ms_is_active', $phone->ms_is_active) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('last_updateby_user') ? 'is-invalid' : '' }}" type="text" name="last_updateby_user" id="last_updateby_user" value="{{ old('last_updateby_user', $phone->last_updateby_user) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ms_last_update') ? 'is-invalid' : '' }}" type="text" name="ms_last_update" id="ms_last_update" value="{{ old('ms_last_update', $phone->ms_last_update) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ms_phonenumbersearch') ? 'is-invalid' : '' }}" type="text" name="ms_phonenumbersearch" id="ms_phonenumbersearch" value="{{ old('ms_phonenumbersearch', $phone->ms_phonenumbersearch) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ms_phonenumberexcludingareacodesearch') ? 'is-invalid' : '' }}" type="text" name="ms_phonenumberexcludingareacodesearch" id="ms_phonenumberexcludingareacodesearch" value="{{ old('ms_phonenumberexcludingareacodesearch', $phone->ms_phonenumberexcludingareacodesearch) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ms_phone_dnt') ? 'is-invalid' : '' }}" type="text" name="ms_phone_dnt" id="ms_phone_dnt" value="{{ old('ms_phone_dnt', $phone->ms_phone_dnt) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ms_phone_dnt_texting_opt_out') ? 'is-invalid' : '' }}" type="text" name="ms_phone_dnt_texting_opt_out" id="ms_phone_dnt_texting_opt_out" value="{{ old('ms_phone_dnt_texting_opt_out', $phone->ms_phone_dnt_texting_opt_out) }}">
