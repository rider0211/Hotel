...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.estimate-items.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('est_item_quantity') ? 'is-invalid' : '' }}" type="text" name="est_item_quantity" id="est_item_quantity" value="{{ old('est_item_quantity', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('est_item_price') ? 'is-invalid' : '' }}" type="text" name="est_item_price" id="est_item_price" value="{{ old('est_item_price', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('est_item_final_amount') ? 'is-invalid' : '' }}" type="text" name="est_item_final_amount" id="est_item_final_amount" value="{{ old('est_item_final_amount', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('est_item_listprice') ? 'is-invalid' : '' }}" type="text" name="est_item_listprice" id="est_item_listprice" value="{{ old('est_item_listprice', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('est_item_venfactor') ? 'is-invalid' : '' }}" type="text" name="est_item_venfactor" id="est_item_venfactor" value="{{ old('est_item_venfactor', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('est_item_factor_2') ? 'is-invalid' : '' }}" type="text" name="est_item_factor_2" id="est_item_factor_2" value="{{ old('est_item_factor_2', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('est_item_factor_3') ? 'is-invalid' : '' }}" type="text" name="est_item_factor_3" id="est_item_factor_3" value="{{ old('est_item_factor_3', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('est_item_margin') ? 'is-invalid' : '' }}" type="text" name="est_item_margin" id="est_item_margin" value="{{ old('est_item_margin', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('est_item_cost') ? 'is-invalid' : '' }}" type="text" name="est_item_cost" id="est_item_cost" value="{{ old('est_item_cost', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('est_item_profit') ? 'is-invalid' : '' }}" type="text" name="est_item_profit" id="est_item_profit" value="{{ old('est_item_profit', '') }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('est_private_detail') ? 'is-invalid' : '' }}" name="est_private_detail" id="est_private_detail">{{ old('est_private_detail') }}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('est_extenditem_detail') ? 'is-invalid' : '' }}" type="text" name="est_extenditem_detail" id="est_extenditem_detail" value="{{ old('est_extenditem_detail', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('est_price_detail') ? 'is-invalid' : '' }}" type="text" name="est_price_detail" id="est_price_detail" value="{{ old('est_price_detail', '') }}">
