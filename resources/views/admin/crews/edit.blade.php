    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.crews.update", [$crew->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('crew_name') ? 'is-invalid' : '' }}" type="text" name="crew_name" id="crew_name" value="{{ old('crew_name', $crew->crew_name) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('crew_color') ? 'is-invalid' : '' }}" type="text" name="crew_color" id="crew_color" value="{{ old('crew_color', $crew->crew_color) }}">
