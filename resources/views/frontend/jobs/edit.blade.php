                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.jobs.update", [$job->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="job_title" id="job_title" value="{{ old('job_title', $job->job_title) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="contact" id="contact" value="{{ old('contact', $job->contact) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="lead" id="lead" value="{{ old('lead', $job->lead) }}">
                            @if($errors->has('lead'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('lead') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="job_site" id="job_site" value="{{ old('job_site', $job->job_site) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="job_number" id="job_number" value="{{ old('job_number', $job->job_number) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="job_name" id="job_name" value="{{ old('job_name', $job->job_name) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="job_desc" id="job_desc" value="{{ old('job_desc', $job->job_desc) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="job_type" id="job_type" value="{{ old('job_type', $job->job_type) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="job_status" id="job_status" value="{{ old('job_status', $job->job_status) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="job_address_1" id="job_address_1" value="{{ old('job_address_1', $job->job_address_1) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="job_address_2" id="job_address_2" value="{{ old('job_address_2', $job->job_address_2) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="job_city" id="job_city" value="{{ old('job_city', $job->job_city) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="job_state" id="job_state" value="{{ old('job_state', $job->job_state) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="job_zip" id="job_zip" value="{{ old('job_zip', $job->job_zip) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="job_structure_value_code" id="job_structure_value_code" value="{{ old('job_structure_value_code', $job->job_structure_value_code) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="job_note" id="job_note" value="{{ old('job_note', $job->job_note) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="job_start_date" id="job_start_date" value="{{ old('job_start_date', $job->job_start_date) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="sale_date" id="sale_date" value="{{ old('sale_date', $job->sale_date) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="job_completed_date" id="job_completed_date" value="{{ old('job_completed_date', $job->job_completed_date) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="qb_sync" id="qb_sync" value="{{ old('qb_sync', $job->qb_sync) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="qb_sync_date" id="qb_sync_date" value="{{ old('qb_sync_date', $job->qb_sync_date) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="qb" id="qb" value="{{ old('qb', $job->qb) }}">
                            @if($errors->has('qb'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('qb') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="is_active" id="is_active" value="{{ old('is_active', $job->is_active) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="last_updateby" id="last_updateby" value="{{ old('last_updateby', $job->last_updateby) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="last_update" id="last_update" value="{{ old('last_update', $job->last_update) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="lead_appt_sold" id="lead_appt_sold" value="{{ old('lead_appt_sold', $job->lead_appt_sold) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="exported_to_guild_quality" id="exported_to_guild_quality" value="{{ old('exported_to_guild_quality', $job->exported_to_guild_quality) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="job_site_name" id="job_site_name" value="{{ old('job_site_name', $job->job_site_name) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="qbweb" id="qbweb" value="{{ old('qbweb', $job->qbweb) }}">
                            @if($errors->has('qbweb'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('qbweb') }}
                                </div>
