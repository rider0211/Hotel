    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.lead-files.update", [$leadFile->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            <label class="required" for="jfile_title">{{ trans('cruds.leadFile.fields.jfile_title') }}</label>
                            <input class="form-control" type="text" name="jfile_title" id="jfile_title" value="{{ old('jfile_title', $leadFile->jfile_title) }}" required>
