                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.payments.store") }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="pay_amount" id="pay_amount" value="{{ old('pay_amount', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="contract" id="contract" value="{{ old('contract', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="payment_description" id="payment_description" value="{{ old('payment_description', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="payment_date_time" id="payment_date_time" value="{{ old('payment_date_time', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="payment_cc_no" id="payment_cc_no" value="{{ old('payment_cc_no', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="applies_to_contract" id="applies_to_contract" value="{{ old('applies_to_contract', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="cashfinance" id="cashfinance" value="{{ old('cashfinance', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="paysimple_payment" id="paysimple_payment" value="{{ old('paysimple_payment', '') }}">
