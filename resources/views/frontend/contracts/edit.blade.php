                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.contracts.update", [$contract->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="ctr_name" id="ctr_name" value="{{ old('ctr_name', $contract->ctr_name) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="job" id="job" value="{{ old('job', $contract->job) }}">
                            @if($errors->has('job'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('job') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="contract_date" id="contract_date" value="{{ old('contract_date', $contract->contract_date) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="contract_status" id="contract_status" value="{{ old('contract_status', $contract->contract_status) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="contract_date_complete" id="contract_date_complete" value="{{ old('contract_date_complete', $contract->contract_date_complete) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="is_active" id="is_active" value="{{ old('is_active', $contract->is_active) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="last_update" id="last_update" value="{{ old('last_update', $contract->last_update) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="last_updateby" id="last_updateby" value="{{ old('last_updateby', $contract->last_updateby) }}">
