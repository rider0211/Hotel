                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.users.store") }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="user_company" id="user_company" value="{{ old('user_company', '') }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="user_status" id="user_status" value="{{ old('user_status', '') }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="user_role" id="user_role" value="{{ old('user_role', '') }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="user_dept" id="user_dept" value="{{ old('user_dept', '') }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="user_title" id="user_title" value="{{ old('user_title', '') }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="user_color" id="user_color" value="{{ old('user_color', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="goog_pw" id="goog_pw" value="{{ old('goog_pw', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="ticketit_admin" id="ticketit_admin" value="{{ old('ticketit_admin', '') }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="ticketit_agent" id="ticketit_agent" value="{{ old('ticketit_agent', '') }}">
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="ms_is_active" id="ms_is_active" value="1" {{ old('ms_is_active', 0) == 1 ? 'checked' : '' }}>
