                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.activities.update", [$activity->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control ckeditor" name="act_notes" id="act_notes">{!! old('act_notes', $activity->act_notes) !!}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control datetime" type="text" name="act_start" id="act_start" value="{{ old('act_start', $activity->act_start) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control datetime" type="text" name="act_due_by" id="act_due_by" value="{{ old('act_due_by', $activity->act_due_by) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control datetime" type="text" name="act_end" id="act_end" value="{{ old('act_end', $activity->act_end) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="contact" id="contact" value="{{ old('contact', $activity->contact) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="activity_name" id="activity_name" value="{{ old('activity_name', $activity->activity_name) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="activity_type" id="activity_type" value="{{ old('activity_type', $activity->activity_type) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="activity_reference" id="activity_reference" value="{{ old('activity_reference', $activity->activity_reference) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="activity_result" id="activity_result" value="{{ old('activity_result', $activity->activity_result) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="activity_completed_date" id="activity_completed_date" value="{{ old('activity_completed_date', $activity->activity_completed_date) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="activity_due_date" id="activity_due_date" value="{{ old('activity_due_date', $activity->activity_due_date) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="activity_reminder_minutes" id="activity_reminder_minutes" value="{{ old('activity_reminder_minutes', $activity->activity_reminder_minutes) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="activity_notes" id="activity_notes" value="{{ old('activity_notes', $activity->activity_notes) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="appt" id="appt" value="{{ old('appt', $activity->appt) }}">
                            @if($errors->has('appt'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('appt') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="activity_assign_emp" id="activity_assign_emp" value="{{ old('activity_assign_emp', $activity->activity_assign_emp) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="activity_sched_emp" id="activity_sched_emp" value="{{ old('activity_sched_emp', $activity->activity_sched_emp) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="activity_reminder_is_dismissed" id="activity_reminder_is_dismissed" value="{{ old('activity_reminder_is_dismissed', $activity->activity_reminder_is_dismissed) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="is_active" id="is_active" value="{{ old('is_active', $activity->is_active) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="last_updateby" id="last_updateby" value="{{ old('last_updateby', $activity->last_updateby) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="last_update" id="last_update" value="{{ old('last_update', $activity->last_update) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="id_led" id="id_led" value="{{ old('id_led', $activity->id_led) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="activityresultid" id="activityresultid" value="{{ old('activityresultid', $activity->activityresultid) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="activityreferenceid" id="activityreferenceid" value="{{ old('activityreferenceid', $activity->activityreferenceid) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="t_scheduler_event" id="t_scheduler_event" value="{{ old('t_scheduler_event', $activity->t_scheduler_event) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="activity_process_step" id="activity_process_step" value="{{ old('activity_process_step', $activity->activity_process_step) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="id_job" id="id_job" value="{{ old('id_job', $activity->id_job) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="process_type_steps" id="process_type_steps" value="{{ old('process_type_steps', $activity->process_type_steps) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="service_order" id="service_order" value="{{ old('service_order', $activity->service_order) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="contact_marketing_queue" id="contact_marketing_queue" value="{{ old('contact_marketing_queue', $activity->contact_marketing_queue) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="column_27" id="column_27" value="{{ old('column_27', $activity->column_27) }}">
