    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.vendor-files.store") }}" enctype="multipart/form-data">
                        @method('POST')
                        @csrf
                        <div class="form-group">
                            <label class="required" for="vfile_name">{{ trans('cruds.vendorFile.fields.vfile_name') }}</label>
                            <input class="form-control" type="text" name="vfile_name" id="vfile_name" value="{{ old('vfile_name', '') }}" required>
