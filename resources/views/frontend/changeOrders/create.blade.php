    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.change-orders.store") }}" enctype="multipart/form-data">
                        @method('POST')
                        @csrf
                        <div class="form-group">
                            <label for="est_title">{{ trans('cruds.changeOrder.fields.est_title') }}</label>
                            <input class="form-control" type="text" name="est_title" id="est_title" value="{{ old('est_title', '') }}">
