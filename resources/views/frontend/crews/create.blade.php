    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.crews.store") }}" enctype="multipart/form-data">
                        @method('POST')
                        @csrf
                        <div class="form-group">
                            <label class="required" for="crew_name">{{ trans('cruds.crew.fields.crew_name') }}</label>
                            <input class="form-control" type="text" name="crew_name" id="crew_name" value="{{ old('crew_name', '') }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="crew_color" id="crew_color" value="{{ old('crew_color', '') }}">
