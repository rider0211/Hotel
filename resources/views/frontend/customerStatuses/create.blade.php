    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.customer-statuses.store") }}" enctype="multipart/form-data">
                        @method('POST')
                        @csrf
                        <div class="form-group">
                            <label for="cs_status">{{ trans('cruds.customerStatus.fields.cs_status') }}</label>
                            <input class="form-control" type="text" name="cs_status" id="cs_status" value="{{ old('cs_status', '') }}">
