    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.vendor-links.store") }}" enctype="multipart/form-data">
                        @method('POST')
                        @csrf
                        <div class="form-group">
                            <label for="ven_link">{{ trans('cruds.vendorLink.fields.ven_link') }}</label>
                            <input class="form-control" type="text" name="ven_link" id="ven_link" value="{{ old('ven_link', '') }}">
