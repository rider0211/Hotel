                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.appointments.update", [$appointment->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control datetime" type="text" name="appt_start_date" id="appt_start_date" value="{{ old('appt_start_date', $appointment->appt_start_date) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control datetime" type="text" name="appt_end_date" id="appt_end_date" value="{{ old('appt_end_date', $appointment->appt_end_date) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="appt_notes" id="appt_notes" value="{{ old('appt_notes', $appointment->appt_notes) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="ms_id_appt_result" id="ms_id_appt_result" value="{{ old('ms_id_appt_result', $appointment->ms_id_appt_result) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="ms_id_appt_reason" id="ms_id_appt_reason" value="{{ old('ms_id_appt_reason', $appointment->ms_id_appt_reason) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="appt_result_code_description" id="appt_result_code_description" value="{{ old('appt_result_code_description', $appointment->appt_result_code_description) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="id_appt_type" id="id_appt_type" value="{{ old('id_appt_type', $appointment->id_appt_type) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="ms_id_appt_type" id="ms_id_appt_type" value="{{ old('ms_id_appt_type', $appointment->ms_id_appt_type) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="ms_id_appt" id="ms_id_appt" value="{{ old('ms_id_appt', $appointment->ms_id_appt) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="appt_sales_1_emp" id="appt_sales_1_emp" value="{{ old('appt_sales_1_emp', $appointment->appt_sales_1_emp) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="appt_subject" id="appt_subject" value="{{ old('appt_subject', $appointment->appt_subject) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="ms_appt_set_by" id="ms_appt_set_by" value="{{ old('ms_appt_set_by', $appointment->ms_appt_set_by) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="confirmation_activity" id="confirmation_activity" value="{{ old('confirmation_activity', $appointment->confirmation_activity) }}">
                        ...
                        <div class="form-group">
                            <div>
                                <input type="checkbox" name="is_active" id="is_active" value="1" {{ $appointment->is_active || old('is_active', 0) === 1 ? 'checked' : '' }} required>
