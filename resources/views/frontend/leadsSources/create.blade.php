    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.leads-sources.store") }}" enctype="multipart/form-data">
                        @method('POST')
                        @csrf
                        <div class="form-group">
                            <label class="required" for="source_name">{{ trans('cruds.leadsSource.fields.source_name') }}</label>
                            <input class="form-control" type="text" name="source_name" id="source_name" value="{{ old('source_name', '') }}" required>
