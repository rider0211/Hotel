    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.job-events.update", [$jobEvent->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            <label class="required" for="name">{{ trans('cruds.jobEvent.fields.name') }}</label>
                            <input class="form-control" type="text" name="name" id="name" value="{{ old('name', $jobEvent->name) }}" required>
                            @if($errors->has('name'))
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="description" id="description">{{ old('description', $jobEvent->description) }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control datetime" type="text" name="start_date" id="start_date" value="{{ old('start_date', $jobEvent->start_date) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control datetime" type="text" name="end_date" id="end_date" value="{{ old('end_date', $jobEvent->end_date) }}" required>
...
<script>
    ...
    url: '{{ route('frontend.job-events.storeMedia') }}',
    maxFilesize: 2, // MB
    maxFiles: 1,
    addRemoveLinks: true,
    headers: {
