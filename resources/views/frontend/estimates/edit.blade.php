    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.estimates.update", [$estimate->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            <label for="est_stat">{{ trans('cruds.estimate.fields.est_stat') }}</label>
                            <input class="form-control" type="text" name="est_stat" id="est_stat" value="{{ old('est_stat', $estimate->est_stat) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="est_total_before_tax" id="est_total_before_tax" value="{{ old('est_total_before_tax', $estimate->est_total_before_tax) }}" step="0.01">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="est_state_tax" id="est_state_tax" value="{{ old('est_state_tax', $estimate->est_state_tax) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="est_county_tax" id="est_county_tax" value="{{ old('est_county_tax', $estimate->est_county_tax) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="est_total_after_tax" id="est_total_after_tax" value="{{ old('est_total_after_tax', $estimate->est_total_after_tax) }}">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control ckeditor" name="est_note" id="est_note">{!! old('est_note', $estimate->est_note) !!}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="dep_calc_1" id="dep_calc_1" value="{{ old('dep_calc_1', $estimate->dep_calc_1) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="dep_calc_2" id="dep_calc_2" value="{{ old('dep_calc_2', $estimate->dep_calc_2) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="dep_calc_3" id="dep_calc_3" value="{{ old('dep_calc_3', $estimate->dep_calc_3) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="est_desposit_1" id="est_desposit_1" value="{{ old('est_desposit_1', $estimate->est_desposit_1) }}" step="0.01">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="est_desposit_2" id="est_desposit_2" value="{{ old('est_desposit_2', $estimate->est_desposit_2) }}" step="0.01">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="est_deposit_3" id="est_deposit_3" value="{{ old('est_deposit_3', $estimate->est_deposit_3) }}" step="0.01">
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="est_view_price" id="est_view_price" value="1" {{ $estimate->est_view_price || old('est_view_price', 0) === 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="est_view_qty" id="est_view_qty" value="1" {{ $estimate->est_view_qty || old('est_view_qty', 0) === 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="est_view_detail" id="est_view_detail" value="1" {{ $estimate->est_view_detail || old('est_view_detail', 0) === 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="est_access" id="est_access" value="{{ old('est_access', $estimate->est_access) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="est_cust_email_signed" id="est_cust_email_signed" value="{{ old('est_cust_email_signed', $estimate->est_cust_email_signed) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="est_cust_first_signed" id="est_cust_first_signed" value="{{ old('est_cust_first_signed', $estimate->est_cust_first_signed) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="est_cust_last_signed" id="est_cust_last_signed" value="{{ old('est_cust_last_signed', $estimate->est_cust_last_signed) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="est_sign" id="est_sign" value="{{ old('est_sign', $estimate->est_sign) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="est_sign_int" id="est_sign_int" value="{{ old('est_sign_int', $estimate->est_sign_int) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="est_approve_date" id="est_approve_date" value="{{ old('est_approve_date', $estimate->est_approve_date) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="est_user_ip" id="est_user_ip" value="{{ old('est_user_ip', $estimate->est_user_ip) }}">
