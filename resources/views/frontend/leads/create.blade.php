    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.leads.store") }}" enctype="multipart/form-data">
                        @method('POST')
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="email" name="email_2" id="email_2" value="{{ old('email_2') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="homephone" id="homephone" value="{{ old('homephone', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="goog_address" id="goog_address" value="{{ old('goog_address', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="lead_lon" id="lead_lon" value="{{ old('lead_lon', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="lead_lat" id="lead_lat" value="{{ old('lead_lat', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="lead_street" id="lead_street" value="{{ old('lead_street', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="lead_lot" id="lead_lot" value="{{ old('lead_lot', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="lead_city" id="lead_city" value="{{ old('lead_city', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="lead_state" id="lead_state" value="{{ old('lead_state', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="lead_zip" id="lead_zip" value="{{ old('lead_zip', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="lead_county" id="lead_county" value="{{ old('lead_county', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="dateassigned" id="dateassigned" value="{{ old('dateassigned', '') }}">
