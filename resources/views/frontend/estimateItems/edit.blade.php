    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.estimate-items.update", [$estimateItem->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            <label for="item_code">{{ trans('cruds.estimateItem.fields.item_code') }}</label>
                            <input class="form-control" type="text" name="item_code" id="item_code" value="{{ old('item_code', $estimateItem->item_code) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="item_name" id="item_name" value="{{ old('item_name', $estimateItem->item_name) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="est_item_quantity" id="est_item_quantity" value="{{ old('est_item_quantity', $estimateItem->est_item_quantity) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="est_item_price" id="est_item_price" value="{{ old('est_item_price', $estimateItem->est_item_price) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="est_item_final_amount" id="est_item_final_amount" value="{{ old('est_item_final_amount', $estimateItem->est_item_final_amount) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="est_item_listprice" id="est_item_listprice" value="{{ old('est_item_listprice', $estimateItem->est_item_listprice) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="est_item_venfactor" id="est_item_venfactor" value="{{ old('est_item_venfactor', $estimateItem->est_item_venfactor) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="est_item_factor_2" id="est_item_factor_2" value="{{ old('est_item_factor_2', $estimateItem->est_item_factor_2) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="est_item_factor_3" id="est_item_factor_3" value="{{ old('est_item_factor_3', $estimateItem->est_item_factor_3) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="est_item_margin" id="est_item_margin" value="{{ old('est_item_margin', $estimateItem->est_item_margin) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="est_item_cost" id="est_item_cost" value="{{ old('est_item_cost', $estimateItem->est_item_cost) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="est_item_profit" id="est_item_profit" value="{{ old('est_item_profit', $estimateItem->est_item_profit) }}">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="est_private_detail" id="est_private_detail">{{ old('est_private_detail', $estimateItem->est_private_detail) }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="est_extenditem_detail" id="est_extenditem_detail" value="{{ old('est_extenditem_detail', $estimateItem->est_extenditem_detail) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="est_price_detail" id="est_price_detail" value="{{ old('est_price_detail', $estimateItem->est_price_detail) }}">
