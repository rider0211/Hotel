    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.work-orders.store") }}" enctype="multipart/form-data">
                        @method('POST')
                        @csrf
                        <div class="form-group">
                            <label for="swo_title">{{ trans('cruds.workOrder.fields.swo_title') }}</label>
                            <input class="form-control" type="text" name="swo_title" id="swo_title" value="{{ old('swo_title', '') }}">
