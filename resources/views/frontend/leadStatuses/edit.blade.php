    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.lead-statuses.update", [$leadStatus->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            <label class="required" for="lead_stat">{{ trans('cruds.leadStatus.fields.lead_stat') }}</label>
                            <input class="form-control" type="text" name="lead_stat" id="lead_stat" value="{{ old('lead_stat', $leadStatus->lead_stat) }}" required>
