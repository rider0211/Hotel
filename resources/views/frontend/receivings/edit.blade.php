    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.receivings.update", [$receiving->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            <label class="required" for="rcv_vendor">{{ trans('cruds.receiving.fields.rcv_vendor') }}</label>
                            <input class="form-control" type="text" name="rcv_vendor" id="rcv_vendor" value="{{ old('rcv_vendor', $receiving->rcv_vendor) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="rcv_expected" id="rcv_expected" value="{{ old('rcv_expected', $receiving->rcv_expected) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="rcv_received" id="rcv_received" value="{{ old('rcv_received', $receiving->rcv_received) }}">
