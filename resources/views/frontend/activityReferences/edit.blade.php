    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.activity-references.update", [$activityReference->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            <label for="act_notes">{{ trans('cruds.activityReference.fields.act_notes') }}</label>
                            <textarea class="form-control ckeditor" name="act_notes" id="act_notes">{!! old('act_notes', $activityReference->act_notes) !!}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control datetime" type="text" name="act_due_by" id="act_due_by" value="{{ old('act_due_by', $activityReference->act_due_by) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="refer_name" id="refer_name" value="{{ old('refer_name', $activityReference->refer_name) }}" required>
