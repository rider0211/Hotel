    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.activity-types.store") }}" enctype="multipart/form-data">
                        @method('POST')
                        @csrf
                        <div class="form-group">
                            <label class="required" for="act_type">{{ trans('cruds.activityType.fields.act_type') }}</label>
                            <input class="form-control" type="text" name="act_type" id="act_type" value="{{ old('act_type', '') }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control datetime" type="text" name="due_by" id="due_by" value="{{ old('due_by') }}" required>
