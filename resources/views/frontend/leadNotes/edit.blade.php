    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.lead-notes.update", [$leadNote->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            <label for="lead_note">{{ trans('cruds.leadNote.fields.lead_note') }}</label>
                            <textarea class="form-control ckeditor" name="lead_note" id="lead_note">{!! old('lead_note', $leadNote->lead_note) !!}</textarea>
