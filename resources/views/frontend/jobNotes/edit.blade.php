    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.job-notes.update", [$jobNote->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            <label for="jnote">{{ trans('cruds.jobNote.fields.jnote') }}</label>
                            <textarea class="form-control ckeditor" name="jnote" id="jnote">{!! old('jnote', $jobNote->jnote) !!}</textarea>
                            @if($errors->has('jnote'))
