...
class JobNoteController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('frontend.jobNotes.index', compact('jobNotes'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.jobNotes.create');
    }
    ...
    public function store(StoreJobNoteRequest $request)
    {
        ...
        return redirect()->route('frontend.job-notes.index');
    }
    ...
    public function edit(JobNote $jobNote)
    {
        ...
        return view('frontend.jobNotes.edit', compact('jobNote'));
    }
    ...
    public function show(JobNote $jobNote)
    {
        ...
        return view('frontend.jobNotes.show', compact('jobNote'));
    }
