...
class ActivityResultController extends Controller
{
    public function index()
    {
        ...
        return view('frontend.activityResults.index', compact('activityResults'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.activityResults.create');
    }
    ...
    public function store(StoreActivityResultRequest $request)
    {
        ...
        return redirect()->route('frontend.activity-results.index');
    }
    ...
    public function edit(ActivityResult $activityResult)
    {
        ...
        return view('frontend.activityResults.edit', compact('activityResult'));
    }
    ...
    public function show(ActivityResult $activityResult)
    {
        ...
        return view('frontend.activityResults.show', compact('activityResult'));
    }
