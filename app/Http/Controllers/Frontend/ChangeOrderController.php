...
class ChangeOrderController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('frontend.changeOrders.index', compact('changeOrders'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.changeOrders.create');
    }
    ...
    public function store(StoreChangeOrderRequest $request)
    {
        ...
        return redirect()->route('frontend.change-orders.index');
    }
    ...
    public function edit(ChangeOrder $changeOrder)
    {
        ...
        return view('frontend.changeOrders.edit', compact('changeOrder'));
    }
    ...
    public function show(ChangeOrder $changeOrder)
    {
        ...
        return view('frontend.changeOrders.show', compact('changeOrder'));
    }
