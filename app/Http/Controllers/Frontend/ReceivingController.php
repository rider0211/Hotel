...
class ReceivingController extends Controller
{
    public function index()
    {
        ...
        return view('frontend.receivings.index', compact('receivings'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.receivings.create');
    }
    ...
    public function store(StoreReceivingRequest $request)
    {
        ...
        return redirect()->route('frontend.receivings.index');
    }
    ...
    public function edit(Receiving $receiving)
    {
        ...
        return view('frontend.receivings.edit', compact('receiving'));
    }
    ...
    public function show(Receiving $receiving)
    {
        ...
        return view('frontend.receivings.show', compact('receiving'));
    }
