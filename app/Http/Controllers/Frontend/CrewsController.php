...
class CrewsController extends Controller
{
    public function index()
    {
        ...
        return view('frontend.crews.index', compact('crews'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.crews.create');
    }
    ...
    public function store(StoreCrewRequest $request)
    {
        ...
        return redirect()->route('frontend.crews.index');
    }
    ...
    public function edit(Crew $crew)
    {
        ...
        return view('frontend.crews.edit', compact('crew'));
    }
    ...
    public function show(Crew $crew)
    {
        ...
        return view('frontend.crews.show', compact('crew'));
    }
