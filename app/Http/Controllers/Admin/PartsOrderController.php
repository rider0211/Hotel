...
class PartsOrderController extends Controller
{
    public function index()
    {
        ...
        return view('admin.partsOrders.index', compact('partsOrders', 'jobs'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.partsOrders.create', compact('realed_jobs'));
    }
    ...
    public function store(StorePartsOrderRequest $request)
    {
        ...
        return redirect()->route('admin.parts-orders.index');
    }
    ...
    public function edit(PartsOrder $partsOrder)
    {
        ...
        return view('admin.partsOrders.edit', compact('realed_jobs', 'partsOrder'));
    }
    ...
    public function show(PartsOrder $partsOrder)
    {
        ...
        return view('admin.partsOrders.show', compact('partsOrder'));
    }
