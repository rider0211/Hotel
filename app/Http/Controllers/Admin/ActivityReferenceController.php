...
class ActivityReferenceController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.activityReferences.index', compact('activityReferences'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.activityReferences.create');
    }
    ...
    public function store(StoreActivityReferenceRequest $request)
    {
        ...
        return redirect()->route('admin.activity-references.index');
    }
    ...
    public function edit(ActivityReference $activityReference)
    {
        ...
        return view('admin.activityReferences.edit', compact('activityReference'));
    }
    ...
    public function show(ActivityReference $activityReference)
    {
        ...
        return view('admin.activityReferences.show', compact('activityReference'));
    }
