...
class JobFilesController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.jobFiles.index', compact('jobFiles'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.jobFiles.create');
    }
    ...
    public function store(StoreJobFileRequest $request)
    {
        ...
        return redirect()->route('admin.job-files.index');
    }
    ...
    public function edit(JobFile $jobFile)
    {
        ...
        return view('admin.jobFiles.edit', compact('jobFile'));
    }
    ...
    public function show(JobFile $jobFile)
    {
        ...
        return view('admin.jobFiles.show', compact('jobFile'));
    }
